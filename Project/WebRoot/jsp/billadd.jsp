...
<div class="right">
     ...
     <div class="providerAdd">
         <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/jsp/billaddinfo.s">
             ...
             <div class="">
				 ...
				 <!-- 放置提示信息 -->
				 <font color="red">${billCode }</font>
             </div>
             <div>
                 <label for="productName">商品名称：</label>
                 <input type="text" name="productName" id="productName" value=""> 
				 <font color="red">${productName }</font>
             </div>
             <div>
             ...
             <div>
                 <label >是否付款：</label>
                  ...
                  <input type="radio" name="isPayment" value="2" checked="checked">未付款
             </div>
